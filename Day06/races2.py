...
#print(parsing2(data[0]))
#print(parsing2(data[1]))

Time=parsing2(data[0])
Distance=parsing2(data[1])

print(Time,Distance)
i=0
win.append([raceInc(Time,Distance),raceDesc(Time,Distance)])
print(win)
output=1
for a in win:
    wins=0
